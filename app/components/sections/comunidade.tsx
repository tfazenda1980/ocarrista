...
type ComunidadeSectionProps = {
  showLojaHint?: boolean;
};

export function ComunidadeSection({ showLojaHint = true }: ComunidadeSectionProps) {
  return (
    <SectionShell
      id="comunidade"
      ...
      description={
        showLojaHint
          ...
          : "Registe-se como novo membro para integrar a comunidade O Carrista."
      }
      alt
    >
      <div className="mb-10">
