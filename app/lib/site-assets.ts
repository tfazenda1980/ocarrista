...
export const CHALLENGER_VERSION = "1";
...
/** Brasão RC4 — public/images/brasao-rc4.png */
export const BRASAO_SRC = `/images/brasao-rc4.png?v=${BRASAO_VERSION}`;
export const BRASAO_ALT = "Brasão do Regimento de Cavalaria 4 — Ex-RC4";
...
export const CHALLENGER_SRC = `/images/challenger.png?v=${CHALLENGER_VERSION}`;
...
export { GESCO_APP_URL, gescoExternalLink } from "./gesco";
